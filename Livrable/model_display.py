...
def model_display(results):
    ...
    model = KerasClassifier(build_fn=create_model,epochs=300,batch_size=results.iloc[0]['param_batch_size'])
    ...
    if len(results)>1:
        ...
        model = KerasClassifier(build_fn=create_model,epochs=300,batch_size=results.iloc[1]['param_batch_size'])
