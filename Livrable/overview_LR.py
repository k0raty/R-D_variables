...
def overview_LR(dataset,n_layers):
    """
    Main function
    """
    ...
    momentums = ['adadelta','adamax','ftrl','nadam','sgd', 'rmsprop', 'adagrad', 'adam']
    #momentums = ['adam']
    ...
    if len(overview)==0:
        ...
        return momentums
    fig1.savefig("Plots/Pré-paramétrage/Loss_LR")
    fig2.savefig("Plots/Pré-paramétrage/Train_LR")
    fig3.savefig("Plots/Pré-paramétrage/Test_LR")
    overview.to_excel("Excel/Pré-paramétrage/overview_optimizer.xlsx")
    overview.to_pickle("DataFrame/Pré-paramétrage/overview_optimizer.pkl")
