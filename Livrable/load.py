...
def tri(content,L):
    ...
    if next_coor !=-1 :
        if content[:next_coor].find('[') !=-1:
            M=[]
            if content[2:next_coor].find('[') !=-1:
                next_crochet= content[2:next_coor].find('[')
                M.append(content[1:next_crochet+1])
                next_crochet+=2
                while content[next_crochet+1:next_coor].find('[') !=-1:
                    very_next_crochet= content[next_crochet+1:next_coor].find('[')
                    M.append(content[next_crochet:very_next_crochet+next_crochet])
                    next_crochet+=very_next_crochet+1
            else:
                M.append(content[1:next_coor-1])
           
           
            
            L.append(M) #ne prend pas le dernier element
